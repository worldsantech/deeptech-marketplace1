...
def save_project(
    ...
    if current_user.role != "Provider":
        raise HTTPException(
            ...
            detail="Only providers can save projects",
        )
...
def get_my_saved_projects(
    ...
    if current_user.role != "Provider":
        raise HTTPException(
            status_code=status.HTTP_403_FORBIDDEN,
            detail="Only providers can view saved projects",
        )
...
def get_my_saved_project_ids(
    ...
    if current_user.role != "Provider":
        raise HTTPException(
            status_code=status.HTTP_403_FORBIDDEN,
            detail="Only providers can view saved project ids",
        )
...
def remove_saved_project(
    ...
    if current_user.role != "Provider":
        raise HTTPException(
            status_code=status.HTTP_403_FORBIDDEN,
            detail="Only providers can remove saved projects",
        )
